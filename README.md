...
2. If all the thesis wants to be replicated, execute the "A_DatasetDownload.py" script to download "All the News 2.0" dataset or download the [dataset](https://components.one/datasets/all-the-news-2-news-articles-dataset).
